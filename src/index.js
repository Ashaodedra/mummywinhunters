        ...
        active: function () {
            ...
            let initGame = function () {
                ...
                if ((location.hostname.indexOf("sounds.fugaso.com") !== -1 || location.hostname.indexOf("game-proqram.com") !== -1)
                    && (!localStorage.getItem("gameVersion") || localStorage.getItem("gameVersion") !== vers.version)) {
                    localStorage.setItem("gameVersion", vers.version);
                ...
                OMY.OMY_SETTING.WEBP_SUPPORT = false;
                ...
                OMY.OMY_SETTING.CACHE_SPINE_ON_START = false;
                ...
                function _changeFullScreen() {
                    if (_showedOverlay) {
                        ...
                        if (window.overlay.parent)
                            OMY.Omy.stage.removeChild(window.overlay);
                    }
