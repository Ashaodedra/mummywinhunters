    ...
    show(wType, text = "", headText = null, responseCode = "", reset = false) {
        ...
        switch (responseCode) {
            ...
            case "BET_WAS_NOT_PLACED": {
                wType = AppConst.WARNING_BET_STATE;
                headText = this._getText(AppConst.LOC_CONST_WARN[responseCode]["head"]);
                text = this._getText(AppConst.LOC_CONST_WARN[responseCode]["text"]);
                break;
            }

            case "SAME_SESSION":
            case "INVALID_TOKEN": {
                wType = AppConst.WARNING_CRASH_CRITICAL;
                headText = this._getText(AppConst.LOC_CONST_WARN[responseCode]["head"]);
                text = this._getText(AppConst.LOC_CONST_WARN[responseCode]["text"]);
                break;
            }
        ...
        OMY.Omy.viewManager.showWindow(this._wName, false,
            ((OMY.Omy.viewManager.gameUI?.visible) ? OMY.Omy.viewManager.gameUI.getWindowLayer() : null));
    }
...
//---------------------------------------
    ...
    _updateLoc() {
        switch (this._wType) {
            ...
            case AppConst.WARNING_CRASH_CRITICAL:
            case AppConst.WARNING_BET_STATE: {
                this._tHead.text = this._getText(AppConst.LOC_CONST_WARN[this._responseCode]["head"]);
                this._tMessage.text = this._getText(AppConst.LOC_CONST_WARN[this._responseCode]["text"]);
                break;
            }
