...
export class ServerWorkBase extends PIXI.utils.EventEmitter {
    ...
    gameConfHandler(e) {
        ...
        else this.netManager.ping(AppG.gameConst.getData("pingInterval") * 1000);
    ...
    handleJoinResponse(e) {
        ...
        AppG.currency = this._currencyO[e.data.realcurrency].symbol;
...
//---------------------------------------
    ...
    get isUserHasCashForBuy() {
        let isUserHas = this.playerBalance >= this.costBuyFree || this._nextAct !== AppConst.API_BET;
        return isUserHas;
    }
